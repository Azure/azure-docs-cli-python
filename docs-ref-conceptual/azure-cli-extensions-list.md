...
The list of extensions is also available  from the CLI. To get it, run [az extension list-available](/cli/azure/extension?view=azure-cli-latest#az_extension_list_available):
...
| [azure-cli-ml](https://docs.microsoft.com/python/api/overview/azure/ml/?view=azure-ml-py) | 1.18.0 | Microsoft Azure Command-Line Tools AzureML Command Module |  |
...
| [databricks](https://github.com/Azure/azure-cli-extensions) | 0.7.0 | Microsoft Azure Command-Line Tools DatabricksClient Extension |  |
...
| [front-door](https://github.com/Azure/azure-cli-extensions/tree/master/src/front-door) | 1.0.9 | Manage networking Front Doors. |  |
...
| [scheduled-query](https://github.com/Azure/azure-cli-extensions) | 0.2.0 | Microsoft Azure Command-Line Tools Scheduled_query Extension | Yes |
| [spring-cloud](https://github.com/Azure/azure-cli-extensions) | 1.1.1 | Microsoft Azure Command-Line Tools spring-cloud Extension |  |
| [ssh](https://github.com/Azure/azure-cli-extensions/tree/master/src/ssh) | 0.1.0 | SSH into VMs | Yes |
| [stack-hci](https://github.com/Azure/azure-cli-extensions/tree/master/src/stack-hci) | 0.1.1 | Microsoft Azure Command-Line Tools AzureStackHCIClient Extension |  |
| [storage-blob-preview](https://github.com/Azure/azure-cli-extensions) | 0.3.0 | Microsoft Azure Command-Line Tools Storage-blob-preview Extension | Yes |
...
| [storage-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/storage-preview) | 0.5.0 | Provides a preview for upcoming storage features. | Yes |
...
| [timeseriesinsights](https://github.com/Azure/azure-cli-extensions/src/timeseriesinsights) | 0.1.3 | Microsoft Azure Command-Line Tools TimeSeriesInsightsClient Extension |  |
...
| [virtual-wan](https://github.com/Azure/azure-cli-extensions/tree/master/src/virtual-wan) | 0.2.1 | Manage virtual WAN, hubs, VPN gateways and VPN sites. | Yes |
